...
class RaftStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StartHeartbeat = channel.unary_unary(
                ...
                request_serializer=raft__pb2.StartHeartbeatRequest.SerializeToString,
                response_deserializer=raft__pb2.HbAck.FromString,
                _registered_method=True)
...
def add_RaftServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StartHeartbeat': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__pb2.StartHeartbeatRequest.FromString,
                    response_serializer=raft__pb2.HbAck.SerializeToString,
            ),
    }
...
class Raft(object):
    ...
    def StartHeartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.Raft/StartHeartbeat',
            raft__pb2.StartHeartbeatRequest.SerializeToString,
            raft__pb2.HbAck.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
